...
const ConceptosReact = () => {
  ...
  const [selectedConceptosEjemploValue, setSelectedConceptosEjemploValue] = useState("");
  ...
  return (
    <>
      <select id="Concepto" value={selectedConceptosValue} onChange={handleConceptosOption}>
      ...
      <select id="Concepto_ejemplo" onChange={handleConceptosEjemploOption} >
        {Conceptos.find((elem)=>elem.tipo == selectedConceptosValue).ejemplos.map((item, index) => (
